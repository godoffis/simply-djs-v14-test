...
function manageSug(interaction, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (button.isButton()) {
            try {
                options.deny = {
                    color: ((_a = options === null || options === void 0 ? void 0 : options.deny) === null || _a === void 0 ? void 0 : _a.color) || '#ED4245'
                };
                options.accept = {
                    color: ((_b = options === null || options === void 0 ? void 0 : options.accept) === null || _b === void 0 ? void 0 : _b.color) || '#00FF00'
                };
                if (button.customId === 'no-sug') {
                    ...
                    const oldemb =  discord_js_1.EmbedBuilder.from(button.message.embeds[0]);;
                    ...
                    if (button.member.permissions.has(discord_js_1.PermissionsBitField.Flags.Administrator)) {
                    ...
                    else if (!button.member.permissions.has(discord_js_1.PermissionsBitField.Flags.Administrator)) {
                ...
                function dec(reason, oldemb, msg, user) {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        oldemb.setColor(((_a = options === null || options === void 0 ? void 0 : options.deny) === null || _a === void 0 ? void 0 : _a.color) || '#ED4245');
                ...
                function aprov(reason, oldemb, msg, user) {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        oldemb.setColor(((_a = options === null || options === void 0 ? void 0 : options.accept) === null || _a === void 0 ? void 0 : _a.color) || '#00FF00');
