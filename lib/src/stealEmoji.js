    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (message.commandId) {
                interaction = message;
                if (!interaction.member.permissions.has(discord_js_1.PermissionsBitField.Flags.ManageEmojisAndStickers))
                ...
                if (!message.member.permissions.has(discord_js_1.PermissionsBitField.Flags.ManageEmojisAndStickers))
