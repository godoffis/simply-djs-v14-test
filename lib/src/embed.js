    ...
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const row = new discord_js_1.ActionRowBuilder().addComponents([done, reject]);
                const row2 = new discord_js_1.ActionRowBuilder().addComponents([slct]);
                    ...
                    collector.on('collect', (button) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (button.customId && button.customId === 'setDelete') {
                                ...
                                titleclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                    if (m.mentions.channels.first()) {
                                        ...
                                        ch.send({
                                            ...
                                            embeds: [discord_js_1.EmbedBuilder.from(preview.embeds[0])]
                                        });
                                        preview.delete().catch(() => { });
                                        msg.delete().catch(() => { });
                                        m.delete().catch(() => { });
                                        resolve(discord_js_1.EmbedBuilder.from(preview.embeds[0]).toJSON());
                                    }
                                }));
                            }
                            ...
                            titleclr.on('collect', (btn) => __awaiter(this, void 0, void 0, function* () {
                                if (btn.customId === 'timestamp-yes') {
                                    ...
                                    preview
                                        .edit({
                                        content: preview.content,
                                        embeds: [discord_js_1.EmbedBuilder.from(preview.embeds[0]).setTimestamp(new Date())]
                                    })
                                        .catch(() => { });
                                }
                                if (btn.customId === 'timestamp-no') {
                                    ...
                                    preview
                                        .edit({
                                        content: preview.content,
                                        embeds: [discord_js_1.EmbedBuilder.from(preview.embeds[0]).setTimestamp(null)]
                                    })
                                        .catch(() => { });
                                }
                            }));
                            ...
                            button.reply({
                                ...
                                ephemeral: true,
                                components: [new discord_js_1.ActionRowBuilder().addComponents([autsel])]
                            });
                            const titleclr = button.channel.createMessageComponentCollector({
                                filter: btnfilt,
                                idle: 60000
                                        ...
                                        preview
                                            ...
                                            embeds: [
                                                discord_js_1.EmbedBuilder.from(preview.embeds[0]).setAuthor({
                                                    name: m.content,
                                                    iconURL: ((_j = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _j === void 0 ? void 0 : _j.iconURL)
                                                        ? (_k = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _k === void 0 ? void 0 : _k.iconURL
                                                        : null,
                                                    url: ((_l = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _l === void 0 ? void 0 : _l.url)
                                                        ? (_m = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _m === void 0 ? void 0 : _m.url
                                                        : null
                                                })
                                            ]
                                        })
                                ...
                                if (menu.values[0] === 'author-icon') {
                                    ...
                                    authclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                        ...
                                        preview
                                            ...
                                            embeds: [
                                                discord_js_1.EmbedBuilder.from(preview.embeds[0]).setAuthor({
                                                    name: ((_p = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _p === void 0 ? void 0 : _p.name)
                                                        ? (_q = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _q === void 0 ? void 0 : _q.name
                                                        : '',
                                                    iconURL: m.content || ((_r = m.attachments.first()) === null || _r === void 0 ? void 0 : _r.url) || '',
                                                    url: ((_s = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _s === void 0 ? void 0 : _s.url)
                                                        ? (_t = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _t === void 0 ? void 0 : _t.url
                                                        : ''
                                                })
                                            ]
                                        })
                                    ...
                                    authclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                        ...
                                        if (!m.content.startsWith('http')) {
                                            ...
                                            preview
                                                ...
                                                embeds: [
                                                    discord_js_1.EmbedBuilder.from(preview.embeds[0]).setAuthor({
                                                        name: ((_u = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _u === void 0 ? void 0 : _u.name)
                                                            ? (_v = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _v === void 0 ? void 0 : _v.name
                                                            : '',
                                                        iconURL: ((_w = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _w === void 0 ? void 0 : _w.iconURL)
                                                            ? (_x = discord_js_1.EmbedBuilder.from(preview.embeds[0]).author) === null || _x === void 0 ? void 0 : _x.iconURL
                                                            : '',
                                                        url: m.content || ''
                                                    })
                                                ]
                            ...
                            titleclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                if (/^#[0-9A-F]{6}$/i.test(m.content)) {
                                    ...
                                    preview
                                        .edit({
                                        content: preview.content,
                                        embeds: [discord_js_1.EmbedBuilder.from(preview.embeds[0]).setColor(m.content)]
                                    })
                                        .catch(() => {
                                        button.followUp({
                            ...
                            titleclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                if (!m.content.startsWith('http')) {
                                    ...
                                    preview
                                        .edit({
                                        content: preview.content,
                                        embeds: [discord_js_1.EmbedBuilder.from(preview.embeds[0]).setURL(m.content)]
                                    })
                                        .catch(() => { });
                                }
                            }));
                            ...
                            titleclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                preview
                                    .edit({
                                    content: preview.content,
                                    embeds: [discord_js_1.EmbedBuilder.from(preview.embeds[0]).setTitle(m.content)]
                                })
                                    .catch(() => { });
                            }));
                        }
                            ...
                            titleclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                preview
                                    .edit({
                                    content: preview.content,
                                    embeds: [discord_js_1.EmbedBuilder.from(preview.embeds[0]).setDescription(m.content)]
                                })
                                    .catch(() => { });
                            }));
                        }
                                        ...
                                        preview
                                            ...
                                            embeds: [
                                                discord_js_1.EmbedBuilder.from(preview.embeds[0]).setFooter({
                                                    text: m.content,
                                                    iconURL: ((_2 = discord_js_1.EmbedBuilder.from(preview.embeds[0]).footer) === null || _2 === void 0 ? void 0 : _2.iconURL)
                                                        ? (_3 = discord_js_1.EmbedBuilder.from(preview.embeds[0]).footer) === null || _3 === void 0 ? void 0 : _3.iconURL
                                                        : null
                                                })
                                            ]
                                        })
                                ...
                                if (menu.values[0] === 'footer-icon') {
                                    ...
                                    authclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                        ...
                                        preview
                                            ...
                                            embeds: [
                                                discord_js_1.EmbedBuilder.from(preview.embeds[0]).setFooter({
                                                    text: ((_5 = discord_js_1.EmbedBuilder.from(preview.embeds[0]).footer) === null || _5 === void 0 ? void 0 : _5.text) || null,
                                                    iconURL: m.content || ((_6 = m.attachments.first()) === null || _6 === void 0 ? void 0 : _6.url) || null
                                                })
                                            ]
                                        })
                                            .catch(() => { });
                    ...
                    collector.on('end', (collected, reason) => __awaiter(this, void 0, void 0, function* () {
                        if (reason === 'time') {
                            const content = new discord_js_1.ButtonBuilder()
                                ...
                                .setDisabled(true);
                            const timerow = new discord_js_1.ActionRowBuilder().addComponents([content]);
                            yield msg.edit({ embeds: [discord_js_1.EmbedBuilder.from(msg.embeds[0])], components: [timerow] });
                        }
                    }));
                }));
            }
