    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (message.commandId) {
                ...
                if (!msg.member.permissions.has(discord_js_1.PermissionsBitField.Flags.Administrator))
            ...
            function btnEngine(data, button, row) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        const clr = data[i].style || discord_js_1.ButtonStyle.Secondary;
                        let url = '';
                    ...
                    function createLink(label, url, emoji) {
                        ...
                        if (!emoji || emoji === null) {
                            btn.setLabel(label).setStyle(discord_js_1.ButtonStyle.Link).setURL(url);
                        }
                        else if (emoji && emoji !== null) {
                            btn.setLabel(label).setStyle(discord_js_1.ButtonStyle.Link).setURL(url).setEmoji(emoji);
                        }
                        return btn;
                    }
